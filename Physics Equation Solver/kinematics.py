...
root = Tk()
root.title('Kinematics Equation Solver')
...
##############################################################################################
# function no. 3 to calculate distance and set final output into the result_string
def calc_d():
    ...
    if 'd' in known:
        ...
        formula = 0
        work = 'Need at least 3 known values to solve! \nProblem Not Solved!'
        d2 = 0.0
    elif 'vi' in known:
        if 'a' in known:
            if 't' in known:
...
##############################################################################################
# function no. 4 to calculate time and set final output into the result_string
def calc_t():
    global results_string
    known = get_known_values()
    if 't' in known:
...
##############################################################################################
# function no. 5 to calculate initial velocity and set final output into the result_string
def calc_vi():
    global results_string
    known = get_known_values()
    if 'vi' in known:
...
##############################################################################################
# function no. 6 to calculate final velocity and set final output into the result_string
def calc_vf():
    global results_string
    known = get_known_values()
    if 'vf' in known:
...
##############################################################################################
# function no. 7 to calculate acceleration and set final output into the result_string
def calc_a():
    global results_string
    known = get_known_values()
    if 'a' in known:
...
##############################################################################################
# function no. 8 to return back to the main window    
def go_back():
    root.destroy()
    call(["python","main.py"])
